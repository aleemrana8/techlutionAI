...
import { X, Send, User, Phone, Mail, Briefcase, MessageSquare, CheckCircle2, MapPin, PhoneCall, ArrowRight, Sparkles, Paperclip, FileText, Image, Film, Trash2 } from 'lucide-react'
...
export default function ContactUsModal({ isOpen, onClose, onSuccess }: Props) {
  ...
  const handleClose = () => {
    onClose()
    setTimeout(() => {
      setForm({ name: '', countryCode: '+92', phone: '', email: '', service: '', message: '' })
      setSent(false)
      setError('')
      setAttachments([])
    }, 300)
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Modal */}
          <motion.div
            className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl border border-white/10 bg-slate-950/[0.98] md:bg-slate-950/95 md:backdrop-blur-xl shadow-2xl shadow-orange-500/5"
          ...
          >
            {/* Glow accents */}
            <div className="absolute -top-px left-0 right-0 h-px bg-gradient-to-r from-transparent via-orange-500/50 to-transparent" />
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-40 h-20 bg-orange-500/10 rounded-full blur-3xl pointer-events-none" />
                ...
                >
                  ...
                  >
                    <p className="text-slate-400 text-sm leading-relaxed">
                      We've successfully received your message, and our team at <span className="text-white font-semibold">Techlution AI</span> is already reviewing your requirements.
                    </p>
                    <p className="text-slate-400 text-sm leading-relaxed">
                      You can expect a response from our experts within the next{' '}
                      <span className="bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent font-bold">24 hours</span>{' '}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <a href="mailto:raleem811811@gmail.com" className="hover:text-orange-400 transition-colors">raleem811811@gmail.com</a>
                    </div>
                  </motion.div>
                  ...
                  >
                    <a
                      href="#services"
                      onClick={handleClose}
                      className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold px-6 py-2.5 rounded-xl shadow-lg shadow-orange-500/20 text-sm hover:shadow-orange-500/30 transition-shadow"
                    >
                ...
                <>
                  ...
                  <div className="mb-7 pr-8">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="w-8 h-px bg-gradient-to-r from-orange-500 to-orange-400" />
                      <span className="text-orange-400 text-xs sm:text-[10px] tracking-[0.28em] uppercase font-semibold">
                        Get in Touch
                      </span>
                    </div>
                    ...
                    <p className="text-slate-500 text-sm mt-2">
                      Tell us what you need — guaranteed response within 24 hours.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full bg-white/[0.03] border border-white/10 text-white rounded-xl pl-10 pr-4 py-3.5 sm:py-3 text-sm placeholder-slate-600 focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/20 focus:bg-white/[0.05] transition-all"
                          />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <select
                            ...
                            className="w-[5.5rem] sm:w-24 bg-slate-900 border border-white/10 text-slate-300 rounded-xl px-2 py-3.5 sm:py-3 text-sm focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/20 transition-all"
                          >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          className="w-full bg-slate-900 border border-white/10 text-slate-300 rounded-xl pl-10 pr-4 py-3.5 sm:py-3 text-sm focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/20 transition-all appearance-none"
                        >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          className="w-full bg-white/[0.03] border border-white/10 text-white rounded-xl pl-10 pr-4 py-3.5 sm:py-3 text-sm placeholder-slate-600 focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/20 focus:bg-white/[0.05] transition-all resize-none"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div
                        ...
                        className="flex items-center gap-3 px-4 py-3 bg-white/[0.02] border border-dashed border-white/10 rounded-xl cursor-pointer hover:border-orange-500/30 hover:bg-white/[0.04] transition-all group"
                      >
                        <Paperclip size={16} className="text-slate-600 group-hover:text-orange-400 transition-colors" />
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full inline-flex items-center justify-center gap-2.5 btn-primary py-4 sm:py-3.5 text-sm font-bold disabled:opacity-50"
                    >
                      <Send size={15} />
